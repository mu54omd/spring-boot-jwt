...
public class AuthService {
    ...
    public TokenPair login(String email, String password) {
        ...
        String newAccessToken = jwtService.generateAccessToken(user.getId().toHexString());
        String newRefreshToken = jwtService.generateRefreshToken(user.getId().toHexString());
